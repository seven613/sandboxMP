...
urlpatterns = [
    ...
    path('basic/structure/add_user/', views_structure.Structure2UserView.as_view(), name='basic_structure-add_user'),
    ...
    path('rbac/role/role2menu_list/', views_role.Role2MeunListView.as_view(), name='rbac-role-role2menu_list'),
]
